...
function App() {
  ...
  return (
    <div className="flex justify-center items-center flex-col min-h-full p-3">
      <h1 className="text-3xl p-2">Todo List App</h1>
      <input
        className="p-2 outline m-2 rounded-lg shadow-md w-80 text-green-500"
        type="text"
      ...
      <p className="text-red-500 font-bold p-2">{error}</p>
      <ul>
        {items.map(item => {
          return (
            <li
